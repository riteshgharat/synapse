  ...
  return (
    <>
      <div className="w-full h-full flex flex-col md:flex-row">
        <div className="w-full h-3/5 md:w-1/2 md:h-full p-10 flex items-center justify-center bg-gradient-to-b md:bg-gradient-to-r from-Tertiary to-Secondary">
        <img src="/model3.png" alt="model 1" className="h-full md:h-3/5"/>
        </div>
